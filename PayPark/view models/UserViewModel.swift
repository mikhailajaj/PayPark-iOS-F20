...
public class UserViewModel : ObservableObject {
    ...
    func getAllUsers(){
        ...
        do{
            ...
            print(#function,"Couldn't feach \(error.localizedDescription)")
        }
    }
    func deleteUser(){
        do{
    ...
    func updateUser(){
        do{
            try moc.save()
            print(#function,"The user inf has been updated successfuly")
        }catch let error as NSError{
            print(#function,"Unable to update user info \(error.localizedDescription)")
        }
    }
}
// Database  created by fire base NoSqL database access by native SDKs
/**
